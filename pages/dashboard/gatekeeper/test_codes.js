...
import { GATEKEEPER, PENDING, SIGNEDOFF } from '../../../helper/constants';
import ViewTestCode from '../../../components/gatekeeper/ViewTestCode';
...
export default function GateKeeperTestCode({ data, tests, user }) {
