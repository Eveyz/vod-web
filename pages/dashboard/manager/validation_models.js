...
import { VALIDATOR_MANAGER } from '../../../helper/constants';
import ManagerMenu from '../../../components/dashboard/ManagerMenu';
import AssignValidator from '../../../components/manager/AssignValidator';
...
export default function ManagerModels({ data, user }) {

	return (
		<ClippedDrawer sidebar={<ManagerMenu selected={"validation_models"} />}>
